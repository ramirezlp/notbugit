    ...
    <div class="container">
        <div class="row" style="margin-bottom: 70px;">
            <div class="col-lg-12">
                ...
                <p class="p-large">Somos un equipo interdisciplinario de programadores, diseñadores, redactores y emprendedores que 
                    buscamos digitalizar organizaciones apalancándonos en <span style="color: #6c55f9;
                    text-decoration: underline;">los procesos actuales, los datos, la tecnología disponible, la experiencia y la cultura.</span> Te ayudamos a generar una ruta digital que impulse tu negocio de forma sostenible.
                </p>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            Soluciones web escalables para respaldar el crecimiento de su negocio, creando productos digitales y generando experiencias increíbles.
                        </p>
                        <a class="btn-solid-reg btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Ver más</a>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Creamos aplicaciones móviles nativas e híbridas, diseñadas para mejorar procesos dentro de tu empresa y conectarte con tus clientes.</p>
                        <a class="btn-solid-reg btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Ver más</a>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Las redes sociales son los espacios de la web donde los usuarios pasan más tiempo online. Ofrecemos servicios de estrategia y gestión de comunidades.</p>
                        <a class="btn-solid-reg btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Ver más</a>
                    </div>
                </div>
                <!-- end of card -->
